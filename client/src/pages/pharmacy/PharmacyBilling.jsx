              ...
              >
                ...
                <Td>
                  {inv.returnStatus && inv.returnStatus !== "NONE" ? (
                    <span
                      className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full border text-[10px] font-extrabold ${RETURN_BADGE[inv.returnStatus]?.className || ""}`}
                    >
                      <RotateCcw className="w-3 h-3" />
                      {RETURN_BADGE[inv.returnStatus]?.label}
                    </span>
                  ) : (
                    <span className="text-slate-300 dark:text-slate-700 text-[10px] font-bold">
                      —
                    </span>
                  )}
                </Td>
