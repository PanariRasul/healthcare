...
export default function Profile() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 font-sans text-slate-900 bg-[#f4f5f7] dark:bg-slate-950 p-2 sm:p-4 rounded-3xl">
      <PageHeader
        title="User Profile"
        subtitle="Manage account credentials and view personal role details"
      />
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-[28px] p-6 shadow-xs">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs font-bold text-[#0f4a29] dark:text-[#52b788] capitalize mt-0.5">
  ...
  return (
    <div className="flex items-start gap-3 p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800">
      ...
      <div className="min-w-0">
        ...
        <p
          className={`text-xs font-bold text-slate-900 dark:text-white truncate mt-0.5 ${capitalize ? "capitalize" : ""}`}
        >
          {value || "—"}
        </p>
      </div>
